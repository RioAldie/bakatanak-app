...
const ResultDisplay = (params: any) => {
  const { talent, prob, id, allResult } = params;
  ...
  return (
    <div className=" h-fit  z-10 flex justify-center flex-col gap-5 items-center">
      ...
      <div className="w-56 h-56 p-8 rounded-full border-4 flex justify-center items-center">
