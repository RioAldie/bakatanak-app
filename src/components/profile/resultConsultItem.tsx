      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-3 gap-4">
        ...
        <div className="flex ">
          ...
          <button
            ...
            type="submit"
            className="py-2 px-4 ms-2 text-sm font-medium text-gray-200 focus:outline-none bg-gray-800 rounded-lg border border-gray-200 hover:bg-gray-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100 ">
            Hapus
          </button>
        </div>
      </div>
